...
epsSiR_l = "(-15.734*(1-XGeL)-14.585*XGeL)*1.4160"
#epsSiR_l = "(-15.734*(1-XGeL)-14.585*XGeL)*1.035"
epsSiI_l = "(10.126*(1-XGeL)+9.517*XGeL)*1.4160"
...
lenx, leny, lenz = 240, 240, 3540 # KMC superlattice units
...
x0_profile = Expression("0.0 + {}*({} < x[2] && x[2] < {}) + ({}-{}*(x[2]-{}))*({} < x[2] && x[2] < {})".format( \
    x0, SiGe_zmin, SiGe_zmin+1310.0, x0, (x0-0.03)/(3800-1310), SiGe_zmin+1310.0, SiGe_zmin+1310.0, SiGe_zmin+3800.0), degree=0)
