...
do
    t=${d##*_}
    egrep 'Si|Ge' KMC_t_$t/I00000000.xyz |awk '{print '$t', $4}' > KMC_t_$t/time_z.dat
done
rm tmp*
...
tar cvfz todownload.tar.gz KMC_t_*/I*000.xyz KMC_t_*/I*000_d.xyz log* Mul*py time_* zint_*dat XGeS_init* #KMC_t_*/InterpXGeS* 
